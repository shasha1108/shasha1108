...
UI = {
    "zh": {
        ...
        "about_end": "我不急着为一种感受下定义，也不替创作者做最后的选择。对我来说，技术更像一门手艺：把那些说不清的东西，慢慢做成可以被看见、被触碰的体验。",
        "gallery_kicker": "一段视觉记忆",
        "gallery_title": "也许你从这些画面认识我。",
        "gallery_body": "这些画面里，有我一直喜欢的颜色和光线，也有一些还没说清的心绪。你可以慢慢拖动这条长卷，也可以展开来看完整画廊。",
    ...
    "en": {
        ...
        "about_end": "I do not rush to define a feeling or make a creator's final choice for them. To me, technology is more like a craft: slowly making what is hard to say into experiences that can be seen and touched.",
        "gallery_kicker": "A visual memory",
        "gallery_title": "Perhaps these are the images through which you know me.",
        "gallery_body": "These images hold colours and light I have always loved, along with feelings I have not yet found words for. Move through the long reel slowly, or open the complete gallery.",
